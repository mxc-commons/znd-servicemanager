...
class ServiceManager implements ServiceLocatorInterface
{
    ...
    public function get($name)
    {
        ...
        $object = $this->createService($resolvedName);
    ...
    protected function createService($name, $options = null)
    {
        try {
            if (isset($this->delegators[$name])) {
                $object = $this->createServiceFromDelegator($name, $options);
            } else {
                $object = $this->createServiceFromFactory($name, $options);
            }
            ...
            throw ServiceNotCreatedException::fromException($name, $exception);
        }
    }

    protected function createServiceFromDelegator($name, array $options = null)
    {

        $creationCallback = $this->delegators[$name]['creation_callback'] ?? null;
        if ($creationCallback) {
        ...
        $this->delegators[$name]['creationCallback'] = $creationCallback;
